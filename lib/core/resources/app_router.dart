...
import 'package:movies_app/watchlist/presentation/components/developer_info.dart';
...
const String developersPath = '/DevelopersInfo';
    ...
    routes: [
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
            name: AppRoutes.developersInfo,
            path: developersPath,
            pageBuilder: (context, state) =>
                const NoTransitionPage(child: DevelopersInfo()),
          ),
        ],
      ),
    ],
